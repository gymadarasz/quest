<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo htmlentities($__base); ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav"> 
        <?php if ($this->session->get('user_id')): ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo htmlentities($__base); ?>home">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo htmlentities($__base); ?>quests">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo htmlentities($__base); ?>contacts">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo htmlentities($__base); ?>search">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo htmlentities($__base); ?>logout">
        ...
        <?php else: ?>
            <li>
                <a href="<?php echo htmlentities($__base); ?>login">
